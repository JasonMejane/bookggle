...
void draw_mode_select(void) {
    ...
    mode_solo_btn_x = mode_x;                    mode_solo_btn_y = y;
    mode_solo_btn_w = mode_w;                     mode_solo_btn_h = mode_h;
    mode_multi_btn_x = mode_x + mode_w + mode_gap; mode_multi_btn_y = y;
    mode_multi_btn_w = mode_w;                     mode_multi_btn_h = mode_h;
    ...
    board4_btn_x = board_x;                     board4_btn_y = y;
    board4_btn_w = board_w;                      board4_btn_h = board_h;
    board5_btn_x = board_x + board_w + board_gap; board5_btn_y = y;
    board5_btn_w = board_w;                       board5_btn_h = board_h;
    ...
    timer90_btn_x = timer_x;                      timer90_btn_y = y;
    timer90_btn_w = timer_w;                       timer90_btn_h = timer_h;
    timer180_btn_x = timer_x + timer_w + timer_gap; timer180_btn_y = y;
    timer180_btn_w = timer_w;                       timer180_btn_h = timer_h;
    ...
    start_btn_x = start_x; start_btn_y = y;
    start_btn_w = start_w; start_btn_h = start_h;
